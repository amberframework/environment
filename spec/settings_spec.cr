...
module Environment
  describe Settings do
    it "loads default environment settings from yaml file" do
      test_yaml = File.read(File.expand_path("./spec/config/test.yml"))
      settings = Settings.from_yaml(test_yaml)
    ...
    it "loads logging color setting from yaml file" do
      color_yaml = File.read(File.expand_path("./spec/config/test_with_color.yml"))
      settings = Settings.from_yaml(color_yaml)
